...
For our first year, see [2023 Softball]({% link _pages/archive/softball/2023.md %})
...
[published schedules]({% link _pages/archive/schedules/softball.md %})
for official times.
...
[Locations]({% link _pages/archive/fields.md %}): SMLL, OCI Field 2\
[General schedule]({% link _pages/archive/schedules/softball.md %}):
...
[Locations]({% link _pages/archive/fields.md %}): SMLL softball, YHS Varsity & JV, Wasuma Upper\
[General schedule]({% link _pages/archive/schedules/softball.md %}):
...
Game Times: 90 minutes or 6 innings [^L]\
[Locations]({% link _pages/archive/fields.md %}): SMLL softball, YHS Varsity & JV\
[General schedule]({% link _pages/archive/schedules/softball.md %}):
* Thurs: 6pm @ SMLL or YHS
